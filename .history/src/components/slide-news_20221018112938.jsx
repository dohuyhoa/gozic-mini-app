        ...
        <div className="news-item">
          <div className="news-item-header">
            <div className="news-item-thumbnail">
              <img
                src="https://bephoaphat.com/uploads/stores/5/2022/10/3850sl-5.jpg"
                alt=""
              />
            </div>
          </div>
          ...
          <div className="new-item-content">
            Nội dung bài viết [Hiện nội dung]Có nên mua bếp từ Kaff KF-3850SL
            không ?1.Mặt kính Schott Ceran cao cấp2.Công suất lớn, tiết kiệm
            điện3.Bảng điều khiển hiện đại và nhiều tính năng thông minh4.Các
            tính năng an toànCó nên mua bếp từ Kaff KF-3850SL [...]
          </div>
        </div>
        {/* {news &&
          news.length > 0 &&
