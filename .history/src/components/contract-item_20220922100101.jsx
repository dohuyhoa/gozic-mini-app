...
class ContractItem extends React.Component {
  constructor(props) {
    ...
    this.handleToggleFormQuyenLoi = this.handleToggleFormQuyenLoi.bind(this);
  ...
  render() {
    ...
    return (
      <div
        className={`contract-item mb-3 p-3 ps-4 pe-4 ${
      ...
      >
        <div className="card" id={contract.id}>
          ...
          >
            ...
            <div
              className="contract-btn-details color-primary d-flex align-items-center p-3"
              type="button"
