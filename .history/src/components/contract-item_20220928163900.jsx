  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <div
          className={`card ${
            this.state.toggleFormBenefit || this.state.toggleFormDetails
              ? "drop-shadow"
              : ""
          }`}
          id={contract.cardNo}
        >
          ...
          >
            <div className="col-4 contract-item-thumbnail">
            ...
            <div className="col-8 contract-item-details d-flex flex-column align-items-start">
              <div className="contract-brand-name color-primary">
                {contract.companyName}
              </div>
              <div className="contract-owner fw-600 fs-6">
                {contract.contractHolderName}
              </div>
              <div className=" d-flex align-items-center fs-6">
                <img src={CardUserIcon} alt="" />
                <span className="contract-date">{contract.contractCode}</span>
              </div>
            </div>
          </div>
          <div
          ...
          <div className="separator border-bottom border-2 border-gray"></div>
          ...
          >
            <FormBenefit key={contract.cardNo} />
