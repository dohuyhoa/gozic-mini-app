...
class ContractModal extends React.Component {
  ...
  render() {
    ...
    return (
      <div
        className="modal-container border w-75 my-0 mx-auto rounded-3 bg-white"
        data-id={this.props.contract.id}
      >
        <div className="modal-top d-flex align-items-center flex-column pt-4">
          ...
          <div className="modal-date mt- d-flex align-items-center mb-2">
            ...
            <span className="ms-2">{this.props.contract.number}</span>
          </div>
        </div>
        <div className="modal-bottom d-flex align-items-center flex-column">
          ...
          <button type="button" className="btn w-100 p-2 color-primary">
            Huỷ
          </button>
        </div>
      </div>
