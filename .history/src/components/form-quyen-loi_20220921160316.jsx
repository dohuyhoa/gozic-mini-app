...
class FormQuyenLoi extends React.Component {
  ...
  render() {
    return (
      <div className="form">
        <div className="form-currency d-flex justify-content-between pb-3 border-bottom border-2 border-gray">
        ...
        <div className="form-currency d-flex justify-content-between py-3 border-bottom border-2 border-gray mb-2">
          <span>Số tiền bồi thường đã thanh toán</span>
          <span className="fw-600 color-primary">300.000.00</span>
        </div>
      </div>
    );
  }
