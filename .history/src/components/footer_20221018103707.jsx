    ...
    <section id="footer">
      <div className="container footer">
        ...
        <div className="footer-item">
          ...
          <div className="text-center fs-14 pt-4 px-5 mt-4 lh-4">
            Copyright &copy; 2019 Bếp Hoà Phát - Giao Hàng Miễn Phí & Lắp Đặt
            Toàn quốc
            <p className="footer-text mt-2">| Thiết Kế &#10084; Bởi ZicZac</p>
          </div>
        </div>
      </div>
    </section>
