...
class ContractItem extends React.Component {
  ...
  handleToggleForm(event) {
    if (!this.state.toggleFormDetails) {
      this.setState({ toggleFormDetails: !this.state.toggleFormDetails });
    } else {
    }
  }
        ...
        <div className="card" id={this.props.id}>
          ...
          >
            ...
            <div
              ...
              type="button"
              onClick={(event) => this.handleToggleForm(event)}
            >
          ...
          <div
            className={`p-3 btn-toggle ${
              this.state.toggleForm ? "is-active" : ""
            }`}
          >
            {this.state.activeFormQuyenLoi !== null ? <FormQuyenLoi /> : null}
            <div
              className="contract-btn-details color-primary d-flex align-items-center "
              type="button"
              onClick={() =>
                this.handleClickToggleQuyenLoi({ id: this.props.number })
              }
            >
              <div className="d-flex align-items-center justify-content-between">
