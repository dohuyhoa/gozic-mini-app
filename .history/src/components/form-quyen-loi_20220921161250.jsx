    ...
    return (
      <div className="form">
        <div className="form-row d-flex justify-content-between pb-3 align-items-center border-bottom border-2 border-gray">
          <span className="form-title fs-14 col-8">Đơn vị tiền tệ</span>
        ...
        <div className="form-row d-flex justify-content-between py-3 border-bottom border-2 border-gray">
          <span className="form-title fs-14 col-8">Quyền lợi chính</span>
          <span className="fw-600 color-primary col-4">Nội chú</span>
        </div>
        <div className="form-row d-flex justify-content-between py-3 border-bottom border-2 border-gray">
          <span className="form-title fs-14 col-8">Tổng hạn mức/ năm</span>
        ...
        <div className="form-row d-flex justify-content-between py-3 border-bottom border-2 border-gray mb-2">
          <span className="form-title fs-14 col-8">
        ...
        <div className="form-row d-flex justify-content-between py-3 border-bottom border-2 border-gray mb-2">
          <span className="form-title fs-14 col-8"> Số tiền còn lại</span>
          <span className="fw-600 color-primary col-4">200.000.000.000</span>
        </div>
      </div>
    );
  }
